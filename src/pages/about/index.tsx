					...
					<div className='w-screen h-auto laptop:w-1/2 pl-4'>
						...
						<h2 className='h-auto text-5xl tablet:text-6xl text-primary font-jtm ml-2 p-0 z-20'>
							<LightUpString
								...
								color={'topurple'}
							/>
							<div className='block tablet:inline-block tablet:ml-6'>
								<LightUpString
									content={`Jan`}
									color={'topurple'}
								/>
						...
						<div className='w-full h-auto laptop:w-5/6 text-lg text-white font-light z-30 flex flex-col text-left gap-5 px-6'>
							<div key={1} className='z-20'>
